...
#   - Chromium        (optional; integration tests skip when unavailable)
...
.PHONY: help
help:
	@echo "octop-browser Build System"
	@echo ""
	...
	@echo "  run              Run octop-browser module"
	...
	@echo "  test             pytest with coverage (integration auto-skips w/o Chrome)"
	@echo ""
...
.PHONY: run
run:
	$(RUN) python -m octop_browser

.PHONY: mcp
mcp:
	$(RUN) python -m octop_browser.mcp_server
...
test:
	@echo "[test] pytest..."
	$(RUN) pytest --cov=octop_browser --cov-report=term-missing
